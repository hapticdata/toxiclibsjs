...
toxi.THREE.ToxiclibsSupport = function(scene){
	this.scene = scene;
...
(function(){
	...
	toxi.THREE.ToxiclibsSupport.createLineGeometry = function(line3d){
	...
	toxi.THREE.ToxiclibsSupport.createMeshGeometry = function(triangleMesh){
		var geometry = new THREE.Geometry();
	...
	toxi.THREE.ToxiclibsSupport.createMesh = function(triangleMesh,material){
	...
	toxi.THREE.ToxiclibsSupport.createParticle = function(position, materials){
	...
	toxi.THREE.ToxiclibsSupport.prototype = {
