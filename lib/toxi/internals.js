...
exports.tests = {
    ...
    isColorGradient: function( o ){
        return hasProperties(o, ['gradient','interpolator','maxDither','addColorAt','calcGradient']);
    },
    isColorList: function( o ){
        return hasProperties( o, ['add','addAll','adjustBrightness','adjustSaturation']);
	},
    isColorRange: function( o ){
        return hasProperties( o, ['add', 'addAlphaRange','addBrightnessRange','addHueRange']);
    },
    isCircle: function( o ){
		return hasProperties( o, ['getCircumference','getRadius','intersectsCircle']);
	},
    isFloatRange: function( o ){
        return hasProperties( o, ['min','max','adjustCurrentBy','getMedian']);
    },
    isHue: function( o ){
        return hasProperties( o, ['getHue','isPrimary']);
    },
	isLine2D: function( o ){
    ...
    isScaleMap: function( o ){
        return hasProperties(o, ['mapFunction','setInputRange','setOutputRange','getMappedValueFor']);
    },
	isTColor: function( o ){
