	...
	(function(){
		...
		LinkedMap.prototype = {
			get: function( id_or_val ){
				var o = this.__inverseMap[id_or_val];
				if( o === undefined ){
					o = this.__map[id_or_val];
				}
				return o;
			},
			getArray: function(){
			...
			has: function( id_or_val ){
				return ( this.__map[ id_or_val ] !== undefined || this.__inverseMap[ id_or_val ] !== undefined );
			},
			put: function( id, val ){
				this.__map[id] = val;
			...
			remove: function( val ){
				...
				this.__list.splice( this.__list.indexOf(val), 1);
			},
			size: function(){
