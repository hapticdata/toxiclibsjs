define(["require", "exports", "module", "../internals","../math/mathUtils",'./Ellipse'], function(require, exports, module) {
...
Circle.from3Points = function(p1,p2,p3) {
	...
	if (mathUtils.abs(deltaA.x) <= 0.0000001 && mathUtils.abs(deltaB.y) <= 0.0000001) {
		centroid = new geom.Vec2D(p2.x + p3.x, p1.y + p2.y).scaleSelf(0.5);
