...
var isMatrix4x4 = function( o ){
    return internals.hasProperties( o, ['identity', 'invert', 'setFrustrum']);
};

var hasXYZ = function( o ){
    return internals.hasProperties( o, ['x','y','z']);
};
...
var Matrix4x4 = function(v11,v12,v13,v14,v21,v22,v23,v24,v31,v32,v33,v34,v41,v42,v43,v44){
	...
	} else if( internals.isArray( v11 ) ){ //if it was sent in as one array
		var array = v11;
