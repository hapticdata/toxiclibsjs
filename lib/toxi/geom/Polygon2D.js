define(["require", "exports", "module", "./Vec2D","./Line2D","./Triangle2D","../internals"], function(require, exports, module) {
...
var hasXY = function( o ){
	return internals.hasProperties(o, ['x','y']);
};
/**
 * @class
 * @member toxi
...
var Polygon2D = function(){
	...
	if(arguments.length > 1){ //comma-separated Vec2D's were passed in
		...
		var arg = arguments[0];
		if( internals.isArray( arg ) ){ // if it was an array of points
...
Polygon2D.prototype = {
	...
	translate: function() {
		var x,y;
		if (arguments.length==1 && hasXY( arguments[0] ) ){
			x=arg.x;
			y=arg.y;
		} else if (arguments.length==2) {
			x=arguments[0];
